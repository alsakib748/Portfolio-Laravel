                ...
                <div class="card">
                    ...
                    @csrf
                            ...
                            <div class="col-sm-10">
                                <select name="blog_category_id" id="blog_category_id" class="form-select" aria-label="Default select example">
                                    ...
                                    @foreach ($categories as $category)
                                        <option  {{ ($blog->blog_category_id == $category->id) ? 'selected' : '' }} value="{{ $category->id }}">{{ $category->blog_category }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ $blog->blog_title }}" class="form-control" id="blog_title" name="blog_title">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control"  value="{{ $blog->blog_tags }}"  name="blog_tags" data-role="tagsinput">
                            </div>
                        </div>
                    ...
                    <center>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img id="showImage" src="{{ asset($blog->blog_image) }}"  class="rounded avatar-lg" alt="Card image cap">
                            </div>
                        </div>
