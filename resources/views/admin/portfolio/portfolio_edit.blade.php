                ...
                <div class="card">
                    ...
                    @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ $portfolio->portfolio_name }}" class="form-control" id="portfolio_name" name="portfolio_name">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ $portfolio->portfolio_title }}"class="form-control" id="portfolio_title" name="portfolio_title">
                    ...
                    <center>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img id="showImage" src="{{ asset($portfolio->portfolio_image) }}"  class="rounded avatar-lg" alt="Card image cap">
                            </div>
                        </div>
